...
# ============================================================================
# Stage 1: Build
# Uses JDK 21 (LTS, matches pom.xml's java.version and is well-supported by
# Lombok's annotation processor), as a proper multi-stage build: pom.xml is
# copied and dependencies resolved *before* the source is copied, so Docker
# layer caching avoids re-downloading every dependency on every rebuild
# (only source changes bust that cache).
# ============================================================================
...
# ============================================================================
# Stage 2: Runtime
# Same JDK 21 base (kept identical to the build stage to guarantee the image
